...
sudo mkdir -p /opt/docker/ssh
sudo mkdir -p /opt/docker/ssh/"$project"
...
sudo chown -R "$username":"$username" /opt/docker/ssh/"$project"
sudo chown -R "$username":"$username" /opt/docker/"$project"
